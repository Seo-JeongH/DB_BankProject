...
public class Staff extends JFrame {
	...
	public Staff() {
		...
		JLabel lblNewLabel_3 = new JLabel("소속은행코드");
		lblNewLabel_3.setBounds(12, 188, 57, 15);
		contentPane.add(lblNewLabel_3);

		JLabel lblNewLabel_4 = new JLabel("소속지점코드");
		lblNewLabel_4.setBounds(12, 224, 57, 15);
		contentPane.add(lblNewLabel_4);

		textField_3 = new JTextField();
		textField_3.setBounds(127, 185, 220, 21);
		contentPane.add(textField_3);
		textField_3.setColumns(10);

		textField_4 = new JTextField();
		textField_4.setBounds(127, 221, 220, 21);
...
//			String SQL = "insert into staff values ('" + textField.getText() + "', '" + textField_1.getText() +"', '"+ textField_2.getText() +"', '"+ textField_3.getText() +"', '"+textField_4.getText()+"');";
//		}
//		catch (SQLException e) {
//			e.printStackTrace();
//		}
//	}
	...
	public void Update() {	//수정 오류아직 ...
		try {
			Statement stmt = conn.createStatement();
			String SQL = "update staff set s_num = '" + textField.getText() + "' where s_name = '" + textField_1.getText() +"'"
	...
	public void Delete() {  //사원번호만 입력해야지 삭제됨. 갑자기 안됨.
		try {
			Statement stmt = conn.createStatement();
			String SQL = "delete from staff where s_num = '" + textField.getText() + "'";
