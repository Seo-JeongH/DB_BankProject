...
public class Bank_Branch extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Bank_Branch frame = new Bank_Branch();
	...
	public Bank_Branch() {
		...
		lblNewLabel.setBounds(12, 203, 57, 15);
		contentPane.add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("지점주소");
		lblNewLabel_1.setBounds(12, 99, 57, 15);
		contentPane.add(lblNewLabel_1);

		JLabel lblNewLabel_2 = new JLabel("지점명");
		...
		textField_3.setBounds(127, 200, 220, 21);
		contentPane.add(textField_3);
		textField_3.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("지점코드");
		lblNewLabel_3.setBounds(12, 55, 57, 15);
	...
	public void Insert() {  //삽입문 
		try {
			...
			String SQL = "INSERT INTO bank_branch "  +  " VALUES('" + textField.getText() + "','" + textField_1.getText() + "', '" 
			+ textField_2.getText() +"', '" + textField_2.getText() + "')";
	...
	public void Update() {	//수정 오류
		try {
			Statement stmt = conn.createStatement();
			String SQL = "update bank_branch set b_b_code = '" + textField.getText() + "' where b_b_name = '" + textField_1.getText() +"'"
					+  "and b_b_address = '" + textField_2.getText() + "'";
			stmt.executeUpdate(SQL);
		}catch (SQLException e) {
			e.printStackTrace();
		}
	...
	public void Delete() {  //은행코드만 입력해야지 삭제됨.
		try {
			Statement stmt = conn.createStatement();
			String SQL = "delete from bank_branch where b_b_code = '" + textField.getText() + "'";
