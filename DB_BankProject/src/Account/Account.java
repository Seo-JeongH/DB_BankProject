...
public class Account extends JFrame {
	...
	public Account() {
		...
		JLabel lblNewLabel_2 = new JLabel("계좌총류");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//				DataIn(textField.getText(),textField_1.getText(),textField_2.getText());
				Insert();
			}
		});
		...
		textField_3.setBounds(127, 197, 220, 21);
		contentPane.add(textField_3);
		textField_3.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("체크카드");
	...
	public void Insert() {  //삽입문 
		try {
			...
			// �� �ؽ�Ʈ �ʵ��� ���� �޾ƿ� ���ο� ���ڵ带 �߰�
			String SQL = "INSERT INTO Account "  +  " VALUES('" + textField.getText() + "','" + textField_1.getText() + "', '" + textField_2.getText() +"', '" +  textField_3.getText() + "')";
	...
	public void Update() {	//수정 오류아직 ...
		try {
			Statement stmt = conn.createStatement();
			String SQL = "update Account set a_num = '" + textField.getText() + "' where a_type = '" + textField_1.getText() +"'"
	...
	public void Delete() {  //사원번호만 입력해야지 삭제됨.
		try {
			Statement stmt = conn.createStatement();
			String SQL = "delete from Account where a_num = '" + textField.getText() + "'";
