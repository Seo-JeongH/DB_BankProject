...
public class Customer extends JFrame {
	...
	public void Insert() {  //삽입문 
		try {
			...
			String SQL = "INSERT INTO customer "  +  " VALUES('" + textField.getText() + "','" + textField_1.getText() + "', '" + textField_2.getText() +
					"', '" + textField_3.getText() +"')";
	...
	public void Update() {	//수정 오류아직 ...
		try {
			Statement stmt = conn.createStatement();
			String SQL = "update customer set c_idnum = '" + textField.getText() + "' where c_name = '" + textField_1.getText() +"'"
	...
	public void Delete() {  //사원번호만 입력해야지 삭제됨.
		try {
			Statement stmt = conn.createStatement();
			String SQL = "delete from customer where c_idnum = '" + textField.getText() + "'";
